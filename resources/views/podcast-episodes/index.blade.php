            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-9">
                    ...
                    @if($podcast->isOwnedBy(Auth::user()))
                          ...
                          <a href='{{ url("podcasts/{$podcast->id}/episodes/create") }}' class="btn btn-outline-info btn-sm fs-0 py-1 px-3">Adicionar Episódio</a>                         
                    @else    
                    ...
                    <div class="mb-4 col-lg-10 px-0">
                        <h5 class="text-secondary fs-0 fs-lg-1">{{ $podcast->description }}</h5>
                    </div>                    
                </div>
            </div>
            @if($podcast->isOwnedBy(Auth::user())) 
                    <div class="my-4">
                    <h4 class="font-weight-bold mb-3 d-inline-block">Todos os Episódios </h4>                    
