...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <h2 class="font-weight-light text-capitalize mb-0 fs-xl-4 fs-sm-3 heading-underline heading-underline-2"><strong class="text-primary">Editando Podcast </strong>
            </h2>
        </div> 
        <form action="{{ url("/podcasts/{$podcast->id}") }}" method="POST">
            ...
            {{ method_field('PATCH') }}
              ...
              <div class="input-group mb-3">
                  ...
                  value="{{ old('website') ?? $podcast->website }}"/>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="3" name="description">{{ old('description') ?? $podcast->description }}</textarea>
                ...
                <div class="offset-md-4 col-md-4">
                    <button class="btn btn-primary mb-3 w-100 mt-2" type="submit"><h4 class="text-white font-weight-bold mb-0 fs-1">Editar Podcast</h4></button> 
                </div>  
            </form>
    </div>
</div>
