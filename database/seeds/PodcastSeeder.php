...
class PodcastSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/5mDAHWKRPaIuOYJfIBaLvW",
            ...
            'download_url' =>"https://open.spotify.com/embed-podcast/episode/5mDAHWKRPaIuOYJfIBaLvW",
            'duration' => "63"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/44eSWCdGU7ELUOWqSOA1CW",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/44eSWCdGU7ELUOWqSOA1CW",
            'duration' => "74"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/1farm6GMWOo5RlWpz7afDZ",
            ...
            'content_html' => "",
            'download_url' => "https://open.spotify.com/embed-podcast/episode/1farm6GMWOo5RlWpz7afDZ",
            'duration' => "31"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/5uFVeRSBxzmYAbGShGaBEX",
            ...
            'content_html' => "",
            'download_url' => "https://open.spotify.com/embed-podcast/episode/5uFVeRSBxzmYAbGShGaBEX",
            'duration' => "35"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/03JLzm1LiyEBp8RiGM4JrM",
            ...
            'content_html' => "",
            'download_url' => "https://open.spotify.com/embed-podcast/episode/03JLzm1LiyEBp8RiGM4JrM",
            'duration' => "72"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/5ZWWHysyqEYjgSbIi1BVpW",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/5ZWWHysyqEYjgSbIi1BVpW",
            'duration' => "17"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/53UJYASqNtZGuU0cHUAjhW",
            'content_text' => "Faris starts the 'Bitcoin Begins' presentation by explaining the basics of money at the Beer & Bitcoin night.",
            'content_html' => "Faris starts the 'Bitcoin Begins' presentation by explaining the basics of money at the Beer & Bitcoin night.",
            'download_url' => "https://open.spotify.com/embed-podcast/episode/53UJYASqNtZGuU0cHUAjhW",
            'duration' => "18"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/2t6v1RMKMf7n1lzb0cQMsQ",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/2t6v1RMKMf7n1lzb0cQMsQ",
            'duration' => "31"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/6SjVPpk8vI01jrUsMyIU9J",
            'content_text' => "Faris and Gordon begin to explain the Bitcoin White Paper by discussing Peer-to-Peer networks",
            'content_html' => "content",
            'download_url' => "https://open.spotify.com/embed-podcast/episode/6SjVPpk8vI01jrUsMyIU9J",
            'duration' => "31"
        ]);
        ...
        $podcast = factory(App\Podcast::class)->states('published')->create([            
            ...
            'website' => 'https://talesfromthecrypt.com',
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/6dBV24tnYQ4o1jJBDijpUx",
            ...
            'content_html' => "",
            'download_url' => "https://open.spotify.com/embed-podcast/episode/6dBV24tnYQ4o1jJBDijpUx",
            'duration' => "29"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/2Jm2f0VkWLH9KS04EasaVl",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/2Jm2f0VkWLH9KS04EasaVl",
            'duration' => "84"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/0kYjUECw8wK03bbXqTIfBW",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/0kYjUECw8wK03bbXqTIfBW",
            'duration' => "102"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/3jukSwNHEFiQLDVi80tJ8j",
            ...
            'content_html' => "Marty sits down with Santiago Siri, co-founder of Democracy.Earth, to talk about a range of topics ",
            'download_url' => "https://open.spotify.com/embed-podcast/episode/3jukSwNHEFiQLDVi80tJ8j",
            'duration' => "57"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/2fsrmSpMJRKu7vtSGUSwAR",
            'content_text' => "Marty is back in the studio with Louis and a special guest, Barstool's resident spider monkey, Nate. In this episode Nate signs a band, PFT makes a cameo to give us a lesson in exponential growth, and Marty answers all the questions Louis and Nate have about the current events in Bitcoin. Tune in to get caught up with all of the news that has been going on in Bitcoin. ",
            'content_html' => "Marty sits down with Santiago Siri, co-founder of Democracy.Earth, to talk about a range of topics ",
            'download_url' => "https://open.spotify.com/embed-podcast/episode/2fsrmSpMJRKu7vtSGUSwAR",
            'duration' => "81"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/2HP6AknT5b62GDO8w6cK3U",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/2HP6AknT5b62GDO8w6cK3U",
            'duration' => "85"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/4ERIiQEvFJwhT4TgNBrKqO",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/4ERIiQEvFJwhT4TgNBrKqO",
            'duration' => "81"
        ]);
        ...
        $podcast = factory(App\Podcast::class)->states('published')->create([            
            ...
            'website' => 'https://citizenbitcoin.world',
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/4kdwKwWU12PHHaa1CTU1g0",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/4kdwKwWU12PHHaa1CTU1g0",
            'duration' => "62"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/3sxeJtulPjXdkPVijqdXrQ",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/3sxeJtulPjXdkPVijqdXrQ",
            'duration' => "98"
        ]);     
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/43w1TlFLY7sp1QCxCxbH9W",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/43w1TlFLY7sp1QCxCxbH9W",
            'duration' => "76"
        ]);
        ...
        $episode = factory(App\Episode::class)->states('published')->create([
            ...
            'url' => "https://open.spotify.com/embed-podcast/episode/0JTU2fFlO4Vv5RpygFggOS",
            ...
            'download_url' => "https://open.spotify.com/embed-podcast/episode/0JTU2fFlO4Vv5RpygFggOS",
            'duration' => "83"
        ]);
